		...
		return (
						<>
							<Textarea readOnly name="copy-textarea" id="copy-textarea" value={this.props.store.copyToClipboardText}  />
							 <HeaderExpand>
										<Body className="px-4 py-4 md:px-28 md:py-8 lg:py-12 flex items-center flex-1 bg-black">
											<div className="mr-4">
											<NavLink to="/"><Logo /></NavLink>
											</div>
												<div>
													<div className="text-4xl relative font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-pink-500 inline-block">Smqrter<span className="font-normal "> AI</span> 
													</div>
													<div className="hidden md:block text-xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-pink-500 inline-block">Augment your life</div>
													<div className="flex">
														<div className={`items-center flex inline-flex ${this.props.store.profile.credits ? " bg-black text-white" : " bg-black text-red-500"} text-sm rounded-md px-3 py-1 font-medium my-2 mr-2`}>
								...
								<div className="border-gray-300 bg-black shadow-sm ">
										<div className="container flex mx-auto px-4 md:px-28 flex select-none">
														<NavLink to="/"
														 exact
														 tabIndex={-1}
														 onClick={()=>this.props.store.toolsKeyword = ""}
														 activeClassName="bg-gray-800 hover:bg-gray-600 text-white transition"
														 className="text-sm text-white flex py-3 px-6 lg:py-4 lg:px-8 cursor-pointer hover:bg-gray-600 rounded-t-md font-medium transition items-center">
															 <IconDashboard className="w-5 h-5 lg:mr-2 transition" />
															 <div className="hidden lg:block">Tools</div>
															</NavLink>
														 
														<div className="relative text-gray-400 focus-within:text-purple-500 flex flex-1 ">
															...
															<Input 
																...
																id="q"
																name="q" 
																className="pl-4 md:pl-14 text-sm bg-black text-white focus:outline-none focus:bg-black focus:text-white transition flex flex-1 w-full" placeholder="Search...  [Shortcut: Ctrl + K]" autoComplete="off" 
														...
														<NavLink to="/my-profile"
														 ...
														 tabIndex="-1"
														 activeClassName="bg-gray-800 hover:bg-gray-600 text-white transition"
														 className={`text-sm text-white flex py-3 px-6 xl:py-4 xl:px-8 cursor-pointer ${this.fromColor} hover:bg-gray-600 rounded-t-md font-medium transition items-center`}><UserCircleIcon className="w-7 h-7 lg:mr-4 transition" />
